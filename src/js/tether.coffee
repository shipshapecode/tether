...
{getScrollParent, getSize, getOuterSize, getBounds, getOffsetParent, extend, addClass, removeClass, updateClasses, defer, flush, getScrollBarSize} = TetherBase.Utils
...
class TetherClass
  ...
  constructor: (options) ->
    ...
    for module in TetherBase.modules
